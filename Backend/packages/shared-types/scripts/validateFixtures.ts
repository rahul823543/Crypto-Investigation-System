...
const VALID_NODE_TYPES    = new Set<string>(["wallet","contract","dex","bridge","mixer","vasp","exchange","unknown"]);
const VALID_RISK_LEVELS   = new Set<RiskLevel>(["low","medium","high","critical"]);
const VALID_LABEL_TYPES   = new Set<AddressLabelType>(["dex","bridge","mixer","vasp","exchange","risky","ofac"]);
