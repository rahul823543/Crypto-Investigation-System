    ...
    <PageFrame>
      ...
      <Card className="max-w-2xl mx-auto border-cyber-cyan/10">
        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-cyber-green/10 border border-cyber-green/20 mb-4">
            <ShieldCheck className="h-8 w-8 text-cyber-green" />
          </div>
          <h2 className="text-xl font-bold text-cyber-text mb-2">Evidence Verification</h2>
          <p className="text-sm text-cyber-text-dim max-w-md">
            Verify that a report hash matches the on-chain evidence record. Supports match, mismatch, and missing states.
          </p>
